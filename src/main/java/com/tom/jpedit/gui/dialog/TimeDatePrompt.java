...
public class TimeDatePrompt extends DependantStage {
    private static final List<String> formats = List.of("MM-dd-yyyy hh:mm a", "MM/dd/yy", "HH:mm", "hh:mm a", "yyyy-MM-dd", "yyyy-MM-dd hh:mm a", "yyyy-MM-dd HH:mm", "EEE MM-dd-yyyy hh:mm a", "EEE yyyy-MM-dd hh:mm a", "EEE MM/dd/yy hh:mm a", "EEE yy/MM/dd hh:mm a", "EEE MM-dd-yyyy HH:mm", "EEE yyyy-MM-dd HH:mm", "EEE MM/dd/yy HH:mm", "EEE yy/MM/dd HH:mm");
    private String result;

    public TimeDatePrompt(@Nullable JPEditWindow owner) {
        ...
        Label infoLabel = new Label("yyyy = Year\nMM = Month number\ndd = Day of month\nEEE = Day of week\na = AM/PM\nH = 24 hour (0-23)\nh = 12 hour (1-12)\nmm = Minutes\nss = Seconds");
        Button goButton = new Button("Insert");
        Button cancelButton = new CancelButton(this, event -> result = null);
    ...
    private void styleElements(
            @NotNull ChoiceBox<?> box,
            @NotNull Button goButton,
            @NotNull Button cancelButton,
        ...
        goButton.prefWidthProperty().bind(root.widthProperty().subtract(rootEmptySpace).divide(2));
        cancelButton.prefWidthProperty().bind(root.widthProperty().subtract(rootEmptySpace).divide(2));
